...
export const MovieDetail = () => {
  ...
  useEffect(() => {
    async function fetchMovie() {
      const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=2dbbc220b94293d52929f08a32fa1483`);
  ...
  useEffect(() => {
    document.title = `${movie.title} / MovieBuddy`;
  })
    ...
    <main>
      <section className='flex justify-around flex-wrap py-5'>
        ...
        <div className='max-w-2xl text-gray-700 text-lg dark:text-white lg:text:left'>
          ...
          <p className="my-4 text-center lg:text-left">
            <span className="mr-2 font-bold hover:underline">IMDB Code:</span>
